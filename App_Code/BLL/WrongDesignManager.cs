...
/// <summary>
/// Summary description for WrongDesignManager
/// </summary>
public class WrongDesignManager
{
	public WrongDesignManager()
	{
		//
    ...
    public static DataSet LoadPart(string cTable, string grade, string stuID)
    {
        ...
        string sql = "Select question,answer,num,Tid,[" + cTable + "].id from WrongTotal," + cTable + " where  " + cTable + ".Id = WrongTotal.Id AND stuID='" + stuID + "' and grade='" + grade + "' and type='WrongDesign' order by num desc";
    ...
    {
        SQLHelper dbAccess = new SQLHelper();	//实例化一个SQLHelper类
        string sql = "select count(*) from WrongTotal where stuId='" + stuId + "' and type='WrongDesign' and grade='" + grade + "' ";
