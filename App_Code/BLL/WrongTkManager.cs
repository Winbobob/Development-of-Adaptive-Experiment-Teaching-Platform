...
/// <summary>
/// Summary description for WrongTkManager
/// </summary>
public class WrongTkManager
{
	public WrongTkManager()
	{
		//
    ...
    public static DataSet LoadPart(string cTable, string grade, string stuID)
    {
        ...
        string sql = "Select qFront,qBack,answer,num,Tid,[" + cTable + "].id from WrongTotal," + cTable + " where  " + cTable + ".Id = WrongTotal.Id AND stuID='" + stuID + "' and grade='" + grade + "' and type='WrongBlank'order by num desc";
