<%@ Page Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="ExerciseHigh.aspx.cs" Inherits="ExerciseHigh" Title="高级练习题" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderCTop" Runat="Server">
    <center>
    <asp:Label ID="lblTitle" runat="server" CssClass="titleLow">高级练习题</asp:Label>
    </center>
</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolderContent" Runat="Server">
    ...
    <table class="style1">
        ...
        <tr>
          <td class="style2">
               <asp:Label ID="Label8" runat="server" CssClass="title">三、</asp:Label></td>
        ...
        <tr>
          <td class="style2">
                <asp:Label ID="Label7" runat="server" CssClass="title">四、</asp:Label></td>
