<%@ Page Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="ExerciseLow.aspx.cs" Inherits="ExerciseLow" Title="初级练习题" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderCTop" Runat="Server">
    <center>
    <asp:Label ID="lblTitle" runat="server" CssClass="titleLow">初级练习题</asp:Label>
    </center>
</asp:Content>
