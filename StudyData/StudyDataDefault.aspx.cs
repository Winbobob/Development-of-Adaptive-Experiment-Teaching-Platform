...
public partial class StudyData_StudyDataDefault : System.Web.UI.Page
{
    ...
    protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("StudyDataPicture1.aspx");
        }
        else
        {
            Response.Redirect("StudyDataVideo1.aspx?videonum=1.3");
        }
    }
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("StudyDataVideo2.aspx?videonum=2.0");
        }
    }
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("StudyDataPicture3.aspx");
        }
        else
        {
            Response.Redirect("StudyDataVideo3.aspx?videonum=3.1");
        }
    }
    protected void ImageButton4_Click(object sender, ImageClickEventArgs e)
    {
        ...
        {
            Response.Redirect("StudyDataPicture4.aspx");
        }
        else
        {
            Response.Redirect("StudyDataVideo4.aspx?videonum=4.1");
        }
    }
    protected void ImageButton5_Click(object sender, ImageClickEventArgs e)
    {
        if (rbl1.SelectedValue == "01")
        {
            Response.Redirect("StudyDataText5.aspx");
        }
        else if (rbl1.SelectedValue == "1")
        {
            Response.Redirect("StudyDataPicture5.aspx");
        }
        else
        {
            Response.Redirect("StudyDataVideo5.aspx?videonum=5.1");
        }
    }
