<%@ Page Language="C#" MasterPageFile="~/StudyData/StudyDataMasterPage.master" AutoEventWireup="true" CodeFile="StudyDataPicture4.aspx.cs" Inherits="StudyData_StudyDataPicture4" Title="无标题页" %>
...
<script type="text/javascript">
    ...
    function openWinCenter() {
        ...
        GB_showCenter("知识点4例题（图片型）", "../example/examplePicture4.aspx", 350, 630);
    }
</script> 
