<%@ Page Language="C#" MasterPageFile="~/StudyData/StudyDataMasterPage.master" AutoEventWireup="true" CodeFile="StudyDataText5.aspx.cs" Inherits="StudyData_StudyDataText5" Title="无标题页" %>
...
(1)string ToString():货的对象的字符串表示。<br />
(2)Type GetType():获得对象的数据类型。<br />
(3)bool Equals(Object obj):判断当前对象与obj是否相等。<br />
(4)int GetHashCode():获得对象的哈希函数值，适用于基于哈希表的数据结构类型。<br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
...
Console.writeLine(o1.GetType());//输出“System.Object”<br />
 o1 = new Student();<br />
Console.WriteLine(o1.GetType());//输出“Student”
  </p>
  <h3 class="style4">5.2 String类</h3>
  <p class="style3"><b>1)字符串与字符数组</b><br />
      ...
      (1)String(char[] v):将字符数组v转换为一个字符串。_<br />
      (2)String(char c, int n):将字符c重复n次来得到一个字符串。<br />
      (3)String(char[] v, int s, int n):从字符数组v的第s个字符开始，取n个字符构成一个字符串。<br />
  下面的示例演示了这些构造函数的用法：<br />
  char[ ] v = new char [ ] {'s','o',f','t','w','a','r','e'};<br />
      srring s1 = new string(v); //s1=&quot;software&quot;     <br />
      string s2 = new string(&#39;M&#39;, 3); //s2=&quot;MMM&quot;        <br />
      string s3 = new string(v,0,4); //s3=&quot;soft&quot;    <br />
      和构造函数相反，String类的ToCharArray方法用于将字符串转换为字符数组，例如： <br />
      string s1 = &quot;北京2008&quot;; <br />
    char[] v1 = s1.ToCharArray(); <br />
      Console.WriteLine(new string(v1)); //输出&quot;北京2008&quot; <br />
      char[] v2 = s1.ToCharArray(3,4); //从s1的第三个字符开始，取4个字符 <br />
      s2 = new string(v2); //s2 = &quot;2008&quot; <br />
      　&nbsp;&nbsp; 
...
string s1 = "北京Olympics";<br />
int i1= sl.ComPareTo("");               //i1=1<br />
int i2 = sl.ComPareTo("北京西客站");    //i2= -1<br />
此外，string类还重载了加法操作符，用于实现字符串的连接，例如：<br />
String s1 = "Beijing";<br />
String s2 = s1+"Rail"+"way";           //s2="Beijing Railway"<br />
S2+="Station";                       //s2="Beijing Railway Station"<br />

<b>2)字符操作</b><br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
      和字符数组相比，String类还通过IndexOf、LastIndexOf、IndexOfAny、和LastIndexOfAny等方法提供了强大的字符查找功能，其中IndexOf方法常用的重载形式有以下几种：<br />
(1)int IndexOf(char c):查找字符c在字符串中首次出现的位置。<br />
(2)int IndexOf(char c, int s ):从字符串的第s个字符开始，查找字符c首次出现的位置。<br />
(3)int IndexOf(char c,int s ,int n):从字符串的第s个字符开始，在n个字符范围内查找字符c首次出现的位置。<br />
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 方法的返回值为指定字符在字符串中的索引位置，如果未找到则返回 -1，LastIndexOf方法与之类似，只不过他是从后向前查找。看下面的代码示例：<br />
      String s1 = &quot;apple&quot;;<br />
      Int i = s1.IndexOf(&#39;p&#39;); //i=1<br />
      i = s1.IndexOf(&#39;l&#39;); //i=3<br />
      i = s1.IndexOf(&#39;l&#39;,0,3); //i=-1<br />
      i = s1.LastIndexOf(&#39;p&#39;); //i=2<br />
      　&nbsp;&nbsp; 
      ...
      char[] v = {&#39;e&#39;,&#39;o&#39;,&#39;t&#39;,};<br />
      String s1 = &quot;Qbject-Oriented&quot;;<br />
      Int i = s1. IndexOfAny(v); //i=3<br />
      i = s1. LastIndexOfAny(v); //i=13<br />
      i = s1. IndexOfAny(v,0,3); //i= -1<br />
      String类中其他一些常用的字符操作方法（及其重载形式）如下：<br />
　·string ToLower():将字符串中的所有大写字母转换为小写字母。<br />
　·string ToUpper():将字符串中的多有小写字母转换为大写字母。<br />
　·string Replace(char c1,char c2):将字符串中所有的c1字符都替换为c2。<br />
　·string Trim():删除字符串两端的所有空格。<br />
　·string Trim(char[]v):将字符数组v中包含的所有字符从字符串两端删除。<br />
　·string PadLeft(int n):向字符串左端填充n个空格。<br />
　·string PadLeft(int n,char c):向字符串左端填充n个字符c。<br />
　·string PadRight(int n):向字符串右端填充n个空格。<br />
　·string PadRight(int n,char c):向字符串右端填充n个字符c。<br />
　要注意这些方法都不修改当前字符串对象的内容，而是将修改后的内容作为一个新字符串对象返回。<br />
      <b>3)子串操作</b><br />
