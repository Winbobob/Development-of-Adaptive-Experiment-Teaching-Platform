<%@ Page Language="C#" MasterPageFile="~/StudyData/StudyDataMasterPage.master" AutoEventWireup="true" CodeFile="StudyDataVideo1.aspx.cs" Inherits="StudyData_StudyDataVideo1" Title="学习资料库-知识点1-视频" %>
    ...
    <asp:Panel ID="PanelAll" runat="server"  ScrollBars="Vertical"  Height="820px"> 
     <h3 align="center" style="font-family: 微软雅黑; font-size: 16pt; color: #006600">知识点1：成员概述</h3>
       ...
       <asp:HyperLink ID="HyperLink1" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo1.aspx?videonum=1.3">1.3静态成员</asp:HyperLink>
       &nbsp;&nbsp;
       <asp:HyperLink ID="HyperLink2" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo1.aspx?videonum=1.4">1.4常量字段</asp:HyperLink>
       <br /><br />
       <center>
       		<!-- flashplayer代码开始 -->
