<%@ Page Language="C#" MasterPageFile="~/StudyData/StudyDataMasterPage.master" AutoEventWireup="true" CodeFile="StudyDataVideo2.aspx.cs" Inherits="StudyData_StudyDataVideo2" Title="无标题页" %>
...
<asp:Panel ID="PanelAll" runat="server"  ScrollBars="Vertical"  Height="820px"> 
     ...
     <asp:Label ID="Label1" runat="server" CssClass="style3"  Text="请选择相应的章节按钮观看视频："></asp:Label><br /><br />
       ...
       <asp:HyperLink ID="HyperLink1" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo2.aspx?videonum=2.0">2方法</asp:HyperLink>
       &nbsp;&nbsp;
       <asp:HyperLink ID="HyperLink2" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo2.aspx?videonum=2.1">2.1方法的返回值</asp:HyperLink>
       &nbsp;&nbsp;
       <asp:HyperLink ID="HyperLink3" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo2.aspx?videonum=2.2">2.2参数类型</asp:HyperLink>
