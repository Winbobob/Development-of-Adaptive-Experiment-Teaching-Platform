<%@ Page Language="C#" MasterPageFile="~/StudyData/StudyDataMasterPage.master" AutoEventWireup="true" CodeFile="StudyDataVideo3.aspx.cs" Inherits="StudyData_StudyDataVideo3" Title="无标题页" %>
...
<asp:Panel ID="PanelAll" runat="server"  ScrollBars="Vertical"  Height="820px"> 
	...
	<asp:HyperLink ID="HyperLink1" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo3.aspx?videonum=3.1">3.1构造函数</asp:HyperLink>
       &nbsp;&nbsp;
       <asp:HyperLink ID="HyperLink2" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo3.aspx?videonum=3.2">3.2属性（上）</asp:HyperLink>
       &nbsp;&nbsp;
       <asp:HyperLink ID="HyperLink3" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo3.aspx?videonum=322">3.2属性（下）</asp:HyperLink>
	 &nbsp;&nbsp;
       <asp:HyperLink ID="HyperLink4" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo3.aspx?videonum=3.3">3.3索引函数</asp:HyperLink>
