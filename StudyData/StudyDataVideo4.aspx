<%@ Page Language="C#" MasterPageFile="~/StudyData/StudyDataMasterPage.master" AutoEventWireup="true" CodeFile="StudyDataVideo4.aspx.cs" Inherits="StudyData_StudyDataVideo4" Title="无标题页" %>
...
<asp:Panel ID="PanelAll" runat="server"  ScrollBars="Vertical"  Height="820px"> 
	...
	<asp:HyperLink ID="HyperLink1" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo4.aspx?videonum=4.1">4this对象引用（上）</asp:HyperLink>
       &nbsp;&nbsp;
       <asp:HyperLink ID="HyperLink2" runat="server" BackColor="#CCCCCC" 
            Font-Size="X-Large" ForeColor="Black" NavigateUrl="~/StudyData/StudyDataVideo4.aspx?videonum=411">4this对象引用（下）</asp:HyperLink>
	<br /><br />
       <center>
      			<!-- flashplayer代码开始 -->
