<%@ Page Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="TestHigh.aspx.cs" Inherits="TestHigh" Title="高级测试题" %>
...
<center>
    <asp:Label ID="lblTitle" runat="server" CssClass="titleLow">高级测试题</asp:Label>
    </center>
</asp:Content>
    ...
    <table class="style1">
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td >
                <asp:FileUpload ID="FUDesignHigh" runat="server" CssClass="question" />
            </td>
            <td class="style8">
