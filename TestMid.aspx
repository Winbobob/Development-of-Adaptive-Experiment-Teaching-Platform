<%@ Page Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="TestMid.aspx.cs" Inherits="TestMid" Title="中级测试题" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderCTop" Runat="Server">
    <center>
    <asp:Label ID="lblTitle" runat="server" CssClass="titleLow">中级测试题</asp:Label>
    </center>
</asp:Content>
    ...
    <table class="style1">
        ...
        <tr>
            <td class="style2">
                &nbsp;</td>
            <td >
                <asp:FileUpload ID="FUDesignMid" runat="server" CssClass="question" />
            </td>
            <td class="style8">
