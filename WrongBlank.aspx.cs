...
public partial class WrongBlank : System.Web.UI.Page
{
    static string j = "WrongBlankLow";
    static string k = "BlankLow";
    static string g = "Low";
    ...
    private void ShowData()
    {
        ...
        DataSet dataset = WrongTkManager.LoadPart(k, g, a);
        GridView1.DataSource = dataset;
        GridView1.DataKeyNames = new string[] { "Tid" };
        GridView1.DataBind();
        lblWTnum.Text = WrongTkManager.Wrongnum(a, g).ToString();
        ddlTitleType.SelectedValue = "1";
    }
    ...
    protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        int n = WrongTkManager.delectTitle1(id);
        if (n > 0)
        {
    ...
    {
        Export("application/ms-word", "填空题错题.doc");
    }
