<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examplePicture3.aspx.cs" Inherits="example_examplePicture3" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>知识点3例题（图片）</title>
...
<asp:Image ID="Image8" runat="server"   ImageUrl="~/DataImage/3.8.jpg"  /><br />
结果如下：<br />
<asp:Image ID="Image14" runat="server"   ImageUrl="~/DataImage/3.14.jpg"  /><br />
解析：<br />
<asp:Image ID="Image15" runat="server"   ImageUrl="~/DataImage/3.15.jpg"  /><br />
  </p>
     </asp:Panel>
</DIV>
...
参考下面这个例子： <br />
<asp:Image ID="Image9" runat="server"   ImageUrl="~/DataImage/3.9.jpg"  /><br />
<asp:Image ID="Image10" runat="server"   ImageUrl="~/DataImage/3.10.jpg"  /><br />
<asp:Image ID="Image11" runat="server"   ImageUrl="~/DataImage/3.11.jpg"  />
...
<DIV class=tagContent id=tagContent2>
        ...
        <p class="style3">
 //普通索引器<br />
 <asp:Image ID="Image12" runat="server"   ImageUrl="~/DataImage/3.12.jpg"  /><br />
<asp:Image ID="Image13" runat="server"   ImageUrl="~/DataImage/3.13.jpg"  /><br />
