<%@ Page Language="C#" AutoEventWireup="true" CodeFile="examplePicture5.aspx.cs" Inherits="example_examplePicture5" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>知识点5例题（图片）</title>
...
<DIV class="tagContent selectTag" id=tagContent0>
        ...
        <p class="style3">
举例：冒泡排序：<br />
<asp:Image ID="Image11" runat="server"   ImageUrl="~/DataImage/5.11.jpg"  /><br />
<asp:Image ID="Image14" runat="server"   ImageUrl="~/DataImage/5.12.jpg"  />
  </p>
     </asp:Panel>
</DIV>
<DIV class=tagContent id=tagContent1>
           ...
           <p class="style3">
  例题：<br />
<asp:Image ID="Image12" runat="server"   ImageUrl="~/DataImage/5.13.jpg"  /><br />
<asp:Image ID="Image15" runat="server"   ImageUrl="~/DataImage/5.14.jpg"  /><br />
<asp:Image ID="Image16" runat="server"   ImageUrl="~/DataImage/5.15.jpg"  /><br />
<asp:Image ID="Image17" runat="server"   ImageUrl="~/DataImage/5.16.jpg"  /><br />
<asp:Image ID="Image18" runat="server"   ImageUrl="~/DataImage/5.17.jpg"  />
...
<DIV class=tagContent id=tagContent2>
        ...
        <p class="style3">
综合应用：<br />
<asp:Image ID="Image19" runat="server"   ImageUrl="~/DataImage/5.18.jpg"  />
  </p>
       </asp:Panel>
</DIV></DIV></DIV>
<p>
